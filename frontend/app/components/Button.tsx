...
export const Button: React.FC<ButtonProps> = ({
  ...
  const baseStyles =
    "px-8 py-3 font-cinzel font-bold text-sm tracking-[0.2em] uppercase transition-all duration-300 active:scale-95 disabled:opacity-30 disabled:cursor-not-allowed rounded-[16px] border-2";
