...
from apps.forum.models import WorldRoomMessages, WorldRoomMediaMessage, WorldRoomSystemMessage


@admin.register(WorldRoomMessages)
class WorldRoomMessagesAdmin(admin.ModelAdmin):
    list_display = ("id", "get_user_name", "get_room_name", "message_type")
...
@admin.register(WorldRoomMediaMessage)
class WorldRoomMediaMessageAdmin(admin.ModelAdmin):
    list_display = ("id", "message", "media_type")
    list_filter = ("media_type",)
    readonly_fields = ('created_at', 'updated_at', 'deleted_at')


@admin.register(WorldRoomSystemMessage)
class WorldRoomSystemMessageAdmin(admin.ModelAdmin):
    list_display = ("id", "message", "event_type")
